...
HD_PWD='C:/Users/theal/Documents/SCHOOL/CMPE 125 Lab/GitLabs/lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_two_stage_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_two_stage_mult.tcl -notrace
