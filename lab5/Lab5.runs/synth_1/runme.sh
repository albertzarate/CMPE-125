...
HD_PWD='C:/Users/theal/Documents/SCHOOL/CMPE 125 Lab/GitLabs/lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_two_stage_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_two_stage_mult.tcl
