...
HD_PWD='C:/Users/theal/Documents/SCHOOL/CMPE 125 Lab/GitLabs/lab6/lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_fifoQ.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_fifoQ.tcl -notrace
