...
HD_PWD='C:/Users/theal/Documents/SCHOOL/CMPE 125 Lab/GitLabs/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_fifoQ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_fifoQ.tcl
